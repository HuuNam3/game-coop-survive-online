...
System.register("chunks:///_virtual/AuthManager.ts",["./rollupPluginModLoBabelHelpers.js","cc"],(function(e){var t,r,n,s,c;return{setters:[function(e){t=e.createClass,r=e.asyncToGenerator,n=e.regeneratorRuntime},function(e){s=e.cclegacy,c=e._decorator}],execute:function(){var a,u;s._RF.push({},"92f565aJulHFK/LclFHvq2s","AuthManager",void 0);var o=c.ccclass;e("AuthManager",o("AuthManager")(((u=function(){function e(){this.publicUrl="https://backend-survive-game.onrender.com"}var s=e.prototype;return s.login=function(){var e=r(n().mark((function e(t,r){var s,c;return n().wrap((function(e){for(;;)switch(e.prev=e.next){case 0:return e.prev=0,console.log("Calling API:",this.publicUrl+"/auth/login"),e.next=4,fetch(this.publicUrl+"/auth/login",{method:"POST",headers:{"Content-Type":"application/json"},credentials:"include",body:JSON.stringify({username:t,password:r})});case 4:return s=e.sent,console.log("Status:",s.status),e.next=8,s.json();case 8:if(c=e.sent,s.ok){e.next=11;break}return e.abrupt("return",{success:!1,message:c.message||"Login failed"});case 11:return e.abrupt("return",{success:!0,user:c.user});case 14:return e.prev=14,e.t0=e.catch(0),console.error("LOGIN ERROR:",e.t0),e.abrupt("return",{success:!1,message:"Network error"});case 18:case"end":return e.stop()}}),e,this,[[0,14]])})));return function(t,r){return e.apply(this,arguments)}}(),s.checkLogin=function(){var e=r(n().mark((function e(){var t;return n().wrap((function(e){for(;;)switch(e.prev=e.next){case 0:return e.prev=0,e.next=3,fetch(this.publicUrl+"/auth/me",{method:"GET",credentials:"include"});case 3:return t=e.sent,console.log("Check login status:",t.status),e.abrupt("return",t.ok);case 8:return e.prev=8,e.t0=e.catch(0),console.error("CHECK LOGIN ERROR:",e.t0),e.abrupt("return",!1);case 12:case"end":return e.stop()}}),e,this,[[0,8]])})));return function(){return e.apply(this,arguments)}}(),s.logout=function(){var e=r(n().mark((function e(){return n().wrap((function(e){for(;;)switch(e.prev=e.next){case 0:return e.prev=0,e.next=3,fetch(this.publicUrl+"/auth/logout",{method:"POST",credentials:"include"});case 3:console.log("Logged out"),e.next=9;break;case 6:e.prev=6,e.t0=e.catch(0),console.error("LOGOUT ERROR:",e.t0);case 9:case"end":return e.stop()}}),e,this,[[0,6]])})));return function(){return e.apply(this,arguments)}}(),t(e,null,[{key:"instance",get:function(){return this._instance||(this._instance=new e),this._instance}}]),e}())._instance=void 0,a=u))||a);s._RF.pop()}}}));
